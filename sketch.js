...
var mute_btn;
var star1,star2,star1_img,star2_img;
var starDisplay,emptyStar_img;
...
function preload() {
  ...
  star1_img = loadImage('assets/star.png');
  star2_img = loadImage('assets/star.png');

  emptyStar_img = loadImage('assets/empty.png');
...
function setup() {
  ...
  blower = createImg('assets/baloon2.png');//not needed 
  ...
  star1 = createSprite(250,50,20,20);
  ...
  starDisplay.addAnimation('1star', star1_img);
  starDisplay.addAnimation('2star', star2_img);
...
function collide(fruit, sprite, x) {
  if (fruit != null) {
